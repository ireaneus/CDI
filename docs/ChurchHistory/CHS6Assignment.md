...
### **Total Depravity: Fallen, Not Autonomous — Yet Fully Accountable**

The doctrine of *total depravity* teaches that every aspect of human nature is affected by sin as a result of Adam’s fall, meaning humanity is spiritually dead and incapable of seeking God apart from grace (**Romans 5:12; Ephesians 2:1–3**). This condition does not imply autonomy; Scripture consistently denies that human beings act independently of God. Rather, all human choices flow from a fallen nature and occur within God’s sovereign restraint and governance (*“In Him we live and move and have our being”* — **Acts 17:28**). God restrains evil through common grace—preventing Abimelech from sinning (**Genesis 20:6**), directing the hearts of rulers (**Proverbs 21:1; Romans 13:1**), and even ordering hardened hearts to fulfill His purposes (**Exodus 9:12; Romans 9:17–18**). The Holy Spirit also restrains lawlessness in the world (**2 Thessalonians 2:6–7**) and indwells believers to oppose the desires of the flesh (**Galatians 5:16**), making it clear that no human action is truly autonomous.

At the same time, Scripture affirms the full **moral responsibility of the unbeliever**. Though fallen and unable to please God, unbelievers are not excused from accountability, because God has clearly revealed Himself through creation and conscience. *“What can be known about God is plain to them… so they are without excuse”* (**Romans 1:19–20**). Humanity’s suppression of truth is not caused by ignorance but by willful rebellion, as people *“did not see fit to acknowledge God”* (**Romans 1:28**). Thus, while no one comes to God apart from divine grace, all are justly accountable for their sin and unbelief. Total depravity denies autonomy but does not deny responsibility; it magnifies God’s justice in judgment and His mercy in salvation, affirming that condemnation is deserved and redemption is wholly of grace (**Romans 3:19; Romans 9:16**).
...
```scss
CHURCH "ORTHODOXY" — KEY EARLY EVENTS (Conciliar / Creedal Foundation)

AD 313 ───────────────────────────────────────────────────────────────────────────────
│  Edict of Milan (Constantine) — Christianity gains legal toleration; public councils possible
│
AD 314 ───────────────────────────────────────────────────────────────────────────────
│  Council of Arles (West) — early imperial-era synod to address church disputes
│
AD 325 ───────────────────────────────────────────────────────────────────────────────
│  Council of Nicaea (First Ecumenical Council)
│    - Rejects Arianism; affirms the Son is truly God
│    - Produces the Nicene Creed (core confession of orthodox faith)
│
AD 330 ───────────────────────────────────────────────────────────────────────────────
│  Constantinople becomes “New Rome” — political center shifts east; church influence follows
│
AD 381 ───────────────────────────────────────────────────────────────────────────────
│  Council of Constantinople (Second Ecumenical Council)
│    - Reaffirms Nicaea; clarifies the doctrine of the Trinity
│    - Expands Nicene confession commonly used in worship
│
AD 431 ───────────────────────────────────────────────────────────────────────────────
│  Council of Ephesus (Third Ecumenical Council)
│    - Rejects Nestorianism; affirms Christ is one person (unity of Christ)
│
AD 451 ───────────────────────────────────────────────────────────────────────────────
│  Council of Chalcedon (Fourth Ecumenical Council)
│    - Defines Christ as truly God and truly man
│    - “Two natures… without confusion, change, division, separation”
│
AD 589 ───────────────────────────────────────────────────────────────────────────────
│  End of the “Christian Roman Empire” era in many church-history frameworks
│  Orthodoxy increasingly identified with the faith preserved in councils, creeds, and liturgy
│
SUMMARY THREAD ───────────────────────────────────────────────────────────────────────
│  Orthodoxy is shaped primarily by:
